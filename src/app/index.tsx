...
const styles = StyleSheet.create({
  ...
  avatarFrame: { width: 106, height: 122, padding: 5, overflow: 'hidden', borderWidth: 1, borderColor: '#285781', backgroundColor: '#0c1b2d' },
  avatarImage: { width: 96, height: 112, backgroundColor: '#0c1b2d', transform: [{ scale: 1.35 }, { translateY: -8 }] },
  ...
  navButton: { alignItems: 'center', paddingVertical: 11, paddingHorizontal: 13, backgroundColor: '#0b1420', borderWidth: 1, borderColor: '#1b324b', flexGrow: 1, minWidth: 120 },
  navButtonActive: { backgroundColor: '#123a61', borderColor: '#3a8bc9' },
  navButtonText: { color: '#8ca3b8', fontWeight: '700', fontSize: 12 },
  navButtonTextActive: { color: '#e9f5ff' },
  card: { backgroundColor: '#0b1420', borderWidth: 1, borderColor: '#1a3047', padding: 22, marginBottom: 16 },
  cardTitle: { fontSize: 22, lineHeight: 29, color: '#edf5fc', fontWeight: '800', marginBottom: 12 },
  cardText: { fontSize: 14, color: '#9eb3c7', lineHeight: 23 },
  detailGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 20, borderTopWidth: 1, borderTopColor: '#1b3854', marginTop: 22, paddingTop: 18 },
  ...
  contactBlock: { borderTopWidth: 1, borderTopColor: '#1b3854', marginTop: 22, paddingTop: 18 },
  ...
  projectCard: { backgroundColor: '#0b1420', borderWidth: 1, borderColor: '#1a3047', overflow: 'hidden', marginBottom: 16 },
  projectImage: { width: '100%', backgroundColor: '#050a12' },
